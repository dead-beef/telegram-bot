...
class BotDatabase:
    INIT = [
        ...
        '  `damage_type_id` REFERENCES `pokemon_type`(`id`),'
        '  `target_type_id` REFERENCES `pokemon_type`(`id`),'
        '  `damage_factor` INTEGER NOT NULL DEFAULT 100,'
        '  UNIQUE (`damage_type_id`, `target_type_id`)'
        ')',
        'CREATE TABLE IF NOT EXISTS `pokemon_exp_type` ('
        '  `id` INTEGER NOT NULL PRIMARY KEY,'
        '  `name` TEXT NOT NULL'
        ')',
        'CREATE TABLE IF NOT EXISTS `pokemon_exp_to_level` ('
        '  `exp_type_id` REFERENCES `pokemon_exp_type`(`id`),'
        '  `level` INTEGER NOT NULL,'
        '  `exp` INTEGER NOT NULL,'
        '  UNIQUE (`exp_type_id`, `level`)'
        ')',
        ...
        '  `name` TEXT NOT NULL,'
        '  `image` TEXT,'
        '  `type_id` REFERENCES `pokemon_type`(`id`),'
        '  `type_2_id` REFERENCES `pokemon_type`(`id`),'
        '  `exp_type_id` REFERENCES `pokemon_exp_type`(`id`),'
        ...
        '  `damage_self` INTEGER NOT NULL DEFAULT 0,'
        '  `status_effect` REFERENCES `status_effect`(`id`),'
        '  `status_chance` INTEGER NOT NULL DEFAULT 100,'
        ...
        '  `iv_hp` INTEGER NOT NULL DEFAULT 10,'
        '  `iv_atk` INTEGER NOT NULL DEFAULT 10,'
        '  `iv_sp_atk` INTEGER NOT NULL DEFAULT 10,'
        '  `iv_def` INTEGER NOT NULL DEFAULT 10,'
        '  `iv_sp_def` INTEGER NOT NULL DEFAULT 10,'
        '  `iv_speed` INTEGER NOT NULL DEFAULT 10'
        ')',
        'CREATE TABLE IF NOT EXISTS `user_pokemon_move` ('
        ...
        '  `name` TEXT NOT NULL,'
        '  `icon` TEXT NOT NULL,'
        '  `can_use_in_battle` INTEGER NOT NULL DEFAULT 0,'
        '  `can_use_in_inventory` INTEGER NOT NULL DEFAULT 1,'
        '  `revive` INTEGER NOT NULL DEFAULT 0,'
        '  `heal` INTEGER NOT NULL DEFAULT 0,'
        '  `restore_pp` INTEGER NOT NULL DEFAULT 0'
        ')',
        ...
        '  `id` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT'
        ')',
        'CREATE TABLE IF NOT EXISTS `pokemon_battle_user` ('
        '  `pokemon_battle_id` REFERENCES `pokemon_battle`(`id`)'
        '                      ON DELETE CASCADE,'
        '  `user_id` REFERENCES `user`(`id`),'
        '  `user_pokemon_id` REFERENCES `user_pokemon`(`id`),'
        '  `selected_action_type` INTEGER,'
        '  `selected_action` INTEGER,'
        '  `selected_action_target` INTEGER,'
        '  `atk_up` INTEGER NOT NULL,'
        '  `sp_atk_up` INTEGER NOT NULL,'
        '  `def_up` INTEGER NOT NULL,'
        '  `sp_def_up` INTEGER NOT NULL,'
        '  `speed_up` INTEGER NOT NULL,'
        '  `acc_up` INTEGER NOT NULL,'
        '  `ev_up` INTEGER NOT NULL,'
        '  `recharging` INTEGER NOT NULL,'
        '  `charging_move` REFERENCES `move`(`id`),'
        '  `charge_duration` INTEGER NOT NULL,'
        '  `recharge_duration` INTEGER NOT NULL,'
        '  `locked_move` REFERENCES `move`(`id`),'
